...
```sh
git clone https://github.com/exp4-age/nomad-age.git
cd nomad-age
...
```sh
pip install dist/nomad-age-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Nikolai Weidt | [nw@uni-kassel.de](mailto:nw@uni-kassel.de)
